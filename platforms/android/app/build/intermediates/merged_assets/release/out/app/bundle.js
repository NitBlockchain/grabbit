...
module.exports = {"android":{"v8Flags":"--expose_gc","forceLog":true,"markingMode":"none"},"main":"main.js"};
...
/* WEBPACK VAR INJECTION */(function(global) {global.registerModule("~@nativescript/theme/css/core.css", () => __webpack_require__(230));
global.registerModule("@nativescript/theme/css/core.css", () => __webpack_require__(230));
global.registerModule("~@nativescript/theme/css/default.css", () => __webpack_require__(231));
global.registerModule("@nativescript/theme/css/default.css", () => __webpack_require__(231));module.exports = {"type":"stylesheet","stylesheet":{"rules":[{"type":"import","import":"'~@nativescript/theme/css/core.css'"},{"type":"import","import":"'~@nativescript/theme/css/default.css'"},{"type":"rule","selectors":[".btn"],"declarations":[{"type":"declaration","property":"font-size","value":"18"}]},{"type":"rule","selectors":[".body"],"declarations":[{"type":"declaration","property":"background-color","value":"#000"}]}],"parsingErrors":[]}};;
    if (false) {}
...
var nativescript_module = __webpack_require__(312);
...
var app_component_AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        Object(core["Component"])({
            selector: "ns-app",
            template: __importDefault(__webpack_require__(482)).default
        })
    ], AppComponent);
    return AppComponent;
}());
...
var fesm5_forms = __webpack_require__(22);
...
var about_component_AboutComponent = /** @class */ (function () {
    ...
    AboutComponent = __decorate([
        Object(core["Component"])({
            selector: "About",
            template: __importDefault(__webpack_require__(497)).default,
            changeDetection: core["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(498)).default]
        }),
...
var fesm5_router = __webpack_require__(31);
...
var create_component_CreateComponent = /** @class */ (function () {
    ...
    CreateComponent = __decorate([
        Object(core["Component"])({
            selector: "Create",
            template: __importDefault(__webpack_require__(500)).default,
            changeDetection: core["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(501)).default]
        }),
...
var create_business_component_CreateBusinessComponent = /** @class */ (function () {
    ...
    CreateBusinessComponent = __decorate([
        Object(core["Component"])({
            selector: "Create",
            template: __importDefault(__webpack_require__(502)).default,
            changeDetection: core["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(503)).default]
        }),
        __metadata("design:paramtypes", [game["a" /* GameProvider */], core["NgZone"], core["ChangeDetectorRef"], common["Location"], router["RouterExtensions"], fesm5_router["ActivatedRoute"], fesm5_forms["FormBuilder"]])
...
var support_component_SupportComponent = /** @class */ (function () {
    ...
    SupportComponent = __decorate([
        Object(core["Component"])({
            selector: "Support",
            template: __importDefault(__webpack_require__(504)).default,
            changeDetection: core["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(505)).default]
        }),
        __metadata("design:paramtypes", [core["NgZone"], core["ChangeDetectorRef"], common["Location"]])
    ], SupportComponent);
...
var legals_component_LegalsComponent = /** @class */ (function () {
    ...
    LegalsComponent = __decorate([
        Object(core["Component"])({
            selector: "Legals",
            template: __importDefault(__webpack_require__(506)).default,
            changeDetection: core["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(507)).default]
        }),
...
var profile_business_component_localStorage = __webpack_require__(157);
// var FileSystem = require("file-system");
// var BackgroundHttp = require("nativescript-background-http");
// var MD5 = require("blueimp-md5");
...
var profile_business_component_ProfileBusinessComponent = /** @class */ (function () {
    ...
    ProfileBusinessComponent = __decorate([
        Object(core["Component"])({
            ...
            template: __importDefault(__webpack_require__(508)).default,
            changeDetection: core["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(509)).default]
        }),
        __metadata("design:paramtypes", [game["a" /* GameProvider */], core["NgZone"], core["ChangeDetectorRef"], common["Location"], router["RouterExtensions"], fesm5_router["ActivatedRoute"], fesm5_forms["FormBuilder"]])
...
var routes = [
    ...
    { path: "home", loadChildren: function () { return Promise.all(/* import() */[__webpack_require__.e(0), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, 545)).then(function (m) { return m.HomeModule; }); } },
...
var http_client = __webpack_require__(313);
...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var nativescript_angular_platform__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(311);
/* harmony import */ var nativescript_angular_platform__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(nativescript_angular_platform__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
/* harmony import */ var _app_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(314);

        let applicationCheckPlatform = __webpack_require__(16);
...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20);
...
var GameProvider = /** @class */ (function () {
    ...
    GameProvider.prototype.login = function (number, device, lat, lng, country, deviceManufacturer, deviceModel, isIOS, isAndroid) {
        // console.log(device)
        var DATA = {
            number: number,
            device: device,
    ...
    GameProvider.prototype.onPayAddress = function (token, user, address) {
        var DATA = {
            user: user,
            token: token,
            address: address
    ...
    GameProvider.prototype.onWithdraw = function (token, user, amount, type) {
        var DATA = {
            user: user,
            token: token,
            amount: amount,

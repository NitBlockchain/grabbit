...
var nativescript_angular_router = __webpack_require__(39);
...
var page_page = __webpack_require__(61);

// EXTERNAL MODULE: ../node_modules/nativescript-clipboard/clipboard.js
var clipboard = __webpack_require__(474);

// EXTERNAL MODULE: ../node_modules/tns-core-modules/timer/timer.js
var timer = __webpack_require__(156);

// EXTERNAL MODULE: ../node_modules/nativescript-social-share/social-share.js
var social_share = __webpack_require__(475);
...
Object(element_registry["registerElement"])("PullToRefresh", function () { return __webpack_require__(473).PullToRefresh; });
...
var home_component_HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.gStorage = function () {
        ...
        this.device = Object(nativescript_uuid["getUUID"])();
        Object(telephony["Telephony"])().then(function (resolved) {
    ...
    HomeComponent.prototype.onShare = function () {
        social_share["shareUrl"]("https://www.nativescript.org/", "come play grabbit with me, we can win awesome prizes");
    };
    ...
    HomeComponent.ctorParameters = function () { return [
        ...
        { type: nativescript_angular_router["RouterExtensions"] },
        { type: page_page["Page"] }
    ]; };
    __decorate([
    ...
    HomeComponent = __decorate([
        Object(core["Component"])({
            selector: "Home",
            template: __importDefault(__webpack_require__(477)).default,
            changeDetection: core["ChangeDetectionStrategy"].OnPush,
            styles: [__importDefault(__webpack_require__(478)).default]
        }),
        __metadata("design:paramtypes", [game["a" /* GameProvider */], core["NgZone"], core["ChangeDetectorRef"], nativescript_angular_router["RouterExtensions"], page_page["Page"]])
    ], HomeComponent);
...
var home_routing_module_HomeRoutingModule = /** @class */ (function () {
    ...
    HomeRoutingModule = __decorate([
        Object(core["NgModule"])({
            imports: [nativescript_angular_router["NativeScriptRouterModule"].forChild(routes)],
            exports: [nativescript_angular_router["NativeScriptRouterModule"]]
        })
    ], HomeRoutingModule);
